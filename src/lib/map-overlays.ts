...
export function buildMapOverlayCatalog(
  ...
  const overlays: MapOverlay[] = [
    ...
    vectorOverlay({
      id: "publicInfrastructure",
      label: "Public Infrastructure",
      shortLabel: "POI",
      description:
        "Police, fire stations, hospitals, clinics, schools, and universities across Phuket. Color-coded: blue=police, red=fire, magenta=health, amber=education.",
    ...
    vectorOverlay({
      ...
      shortLabel: "ROADS",
      description:
        "Phuket's motorway, primary, and secondary roads. Critical for evacuation routing and emergency response.",
    ...
    vectorOverlay({
      id: "canalsDrainage",
      label: "Canals & Drainage",
      shortLabel: "CANAL",
      description:
        "Rivers, canals, streams, and drainage channels — primary determinants of Phuket flood vulnerability. Orange = drains (flood paths).",
      source: "OpenStreetMap",
      family: "weather",
      role: "operational",
      defaultOpacity: 0.92,
    ...
    vectorOverlay({
      ...
      shortLabel: "FLOOD",
      description:
        "Water level monitoring at Phuket flood-prone canals. Color = status (green / yellow / orange / red). Hover for advisory.",
      source: "DDPM + Open-Meteo precipitation",
      family: "weather",
      role: "operational",
      defaultOpacity: 1,
      enabledByDefault: false,
    ...
    vectorOverlay({
      ...
      shortLabel: "SEA",
      description:
        "Wave height, sea temperature, and currents at six Phuket coastal points. Critical for fisheries and coastal flood risk.",
